...
Я добавил некоторые недостающие (ommited) определения, исправил два бага, приводивших к ошибке index of of range, 
а также переработал и значительно ускорил конструирование дерева.
