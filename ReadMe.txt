...
Я добавил некоторые недостающие (ommited) определения, исправил два бага, приводивших к ошибке index of of range, а также переработал и значительно ускорил конструирование дерева.

TestITree.sln - это тестовое приложение (для Visual Studi 2010), которое позволяет оценить скорость и корректность работы класса itree.
